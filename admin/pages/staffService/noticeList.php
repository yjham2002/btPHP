...
<script>
    $(document).ready(function(){
        ...
        $(".jPage").click(function(){
            location.href="/admin/pages/staffService/noticeList.php?page=" + $(this).attr("page");
        });

        $(".jAdd").click(function(){
            location.href="/admin/pages/staffService/noticeDetail.php";
        });

        $(".jDelF").click(function(){
            if(confirm("정말 삭제하시겠습니까?")) {
                var id = $(this).attr("fid");
                var ajax = new AjaxSender("/route.php?cmd=Uncallable.deleteNotice", true, "json", new sehoMap().put("id", id));
        ...
        $(".jMod").click(function(e){
            e.stopPropagation();
            var id = $(this).attr("id");
            location.href="/admin/pages/staffService/noticeDetail.php?id=" + id;
        });

        $(".jView").click(function(){
            var id = $(this).attr("id");
            location.href = "/admin/pages/staffService/noticeView.php?id=" + id;
        });
